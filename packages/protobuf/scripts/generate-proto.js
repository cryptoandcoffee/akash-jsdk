...
try {
  ...
  // Generate index.ts file that exports all generated types
...
function generateIndexFile(generatedDir) {
  // Instead of barrel exporting everything (which causes naming conflicts),
  // just create an empty index that imports the root namespace.
  // Users can import specific types as: import { MsgCreateDeployment } from '@cryptoandcoffee/akash-jsdk-protobuf/generated/akash/deployment/v1beta3/deployment_pb.js'
