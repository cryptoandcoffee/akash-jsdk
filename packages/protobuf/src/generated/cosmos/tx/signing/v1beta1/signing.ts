...
export const SignatureDescriptor_Data: MessageFns<
  SignatureDescriptor_Data,
  "cosmos.tx.signing.v1beta1.SignatureDescriptor.Data"
> = {
  $type: "cosmos.tx.signing.v1beta1.SignatureDescriptor.Data" as const,

  encode(message: SignatureDescriptor_Data, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
export const SignatureDescriptor_Data_Single: MessageFns<
  SignatureDescriptor_Data_Single,
...
> = {
  ...
  encode(message: SignatureDescriptor_Data_Single, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.mode !== 0) {
...
export const SignatureDescriptor_Data_Multi: MessageFns<
...
> = {
  ...
  encode(message: SignatureDescriptor_Data_Multi, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
