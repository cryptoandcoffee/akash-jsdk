...
import { SignMode, signModeFromJSON, signModeToJSON } from "../signing/v1beta1/signing.ts";
...
export const SignDocDirectAux: MessageFns<SignDocDirectAux, "cosmos.tx.v1beta1.SignDocDirectAux"> = {
  $type: "cosmos.tx.v1beta1.SignDocDirectAux" as const,

  encode(message: SignDocDirectAux, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.bodyBytes.length !== 0) {
      writer.uint32(10).bytes(message.bodyBytes);
    }
...
export const ModeInfo_Single: MessageFns<ModeInfo_Single, "cosmos.tx.v1beta1.ModeInfo.Single"> = {
  $type: "cosmos.tx.v1beta1.ModeInfo.Single" as const,

  encode(message: ModeInfo_Single, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.mode !== 0) {
...
export const ModeInfo_Multi: MessageFns<ModeInfo_Multi, "cosmos.tx.v1beta1.ModeInfo.Multi"> = {
  $type: "cosmos.tx.v1beta1.ModeInfo.Multi" as const,

  encode(message: ModeInfo_Multi, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
export const Tip: MessageFns<Tip, "cosmos.tx.v1beta1.Tip"> = {
  $type: "cosmos.tx.v1beta1.Tip" as const,

  encode(message: Tip, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.amount) {
      Coin.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.tipper !== "") {
...
export const AuxSignerData: MessageFns<AuxSignerData, "cosmos.tx.v1beta1.AuxSignerData"> = {
  $type: "cosmos.tx.v1beta1.AuxSignerData" as const,

  encode(message: AuxSignerData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
