...
export const TxDecodeRequest: MessageFns<TxDecodeRequest, "cosmos.tx.v1beta1.TxDecodeRequest"> = {
...
export const TxDecodeResponse: MessageFns<TxDecodeResponse, "cosmos.tx.v1beta1.TxDecodeResponse"> = {
...
export const TxEncodeRequest: MessageFns<TxEncodeRequest, "cosmos.tx.v1beta1.TxEncodeRequest"> = {
...
export const TxEncodeResponse: MessageFns<TxEncodeResponse, "cosmos.tx.v1beta1.TxEncodeResponse"> = {
...
export const TxEncodeAminoRequest: MessageFns<TxEncodeAminoRequest, "cosmos.tx.v1beta1.TxEncodeAminoRequest"> = {
...
export const TxEncodeAminoResponse: MessageFns<TxEncodeAminoResponse, "cosmos.tx.v1beta1.TxEncodeAminoResponse"> = {
...
export const TxDecodeAminoRequest: MessageFns<TxDecodeAminoRequest, "cosmos.tx.v1beta1.TxDecodeAminoRequest"> = {
...
export const TxDecodeAminoResponse: MessageFns<TxDecodeAminoResponse, "cosmos.tx.v1beta1.TxDecodeAminoResponse"> = {
