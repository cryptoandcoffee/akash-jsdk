...
export const MsgUpdateParams: MessageFns<MsgUpdateParams, "cosmos.auth.v1beta1.MsgUpdateParams"> = {
  $type: "cosmos.auth.v1beta1.MsgUpdateParams" as const,
...
> = {
  $type: "cosmos.auth.v1beta1.MsgUpdateParamsResponse" as const,
