...
export const ExistenceProof: MessageFns<ExistenceProof, "cosmos.ics23.v1.ExistenceProof"> = {
...
export const NonExistenceProof: MessageFns<NonExistenceProof, "cosmos.ics23.v1.NonExistenceProof"> = {
...
export const CommitmentProof: MessageFns<CommitmentProof, "cosmos.ics23.v1.CommitmentProof"> = {
...
export const LeafOp: MessageFns<LeafOp, "cosmos.ics23.v1.LeafOp"> = {
...
export const InnerOp: MessageFns<InnerOp, "cosmos.ics23.v1.InnerOp"> = {
...
export const ProofSpec: MessageFns<ProofSpec, "cosmos.ics23.v1.ProofSpec"> = {
  ...
  fromJSON(object: any): ProofSpec {
    return {
      leafSpec: isSet(object.leaf_spec) ? LeafOp.fromJSON(object.leaf_spec) : undefined,
  ...
  toJSON(message: ProofSpec): unknown {
    const obj: any = {};
    if (message.leafSpec !== undefined) {
      obj.leaf_spec = LeafOp.toJSON(message.leafSpec);
    }
    if (message.innerSpec !== undefined) {
      obj.inner_spec = InnerSpec.toJSON(message.innerSpec);
    }
    if (message.maxDepth !== 0) {
      obj.max_depth = Math.round(message.maxDepth);
    }
    if (message.minDepth !== 0) {
...
export const InnerSpec: MessageFns<InnerSpec, "cosmos.ics23.v1.InnerSpec"> = {
  ...
  fromJSON(object: any): InnerSpec {
    return {
      childOrder: globalThis.Array.isArray(object?.child_order)
        ? object.child_order.map((e: any) => globalThis.Number(e))
        : [],
      childSize: isSet(object.child_size) ? globalThis.Number(object.child_size) : 0,
      minPrefixLength: isSet(object.min_prefix_length) ? globalThis.Number(object.min_prefix_length) : 0,
      maxPrefixLength: isSet(object.max_prefix_length) ? globalThis.Number(object.max_prefix_length) : 0,
      emptyChild: isSet(object.empty_child) ? bytesFromBase64(object.empty_child) : new Uint8Array(0),
      hash: isSet(object.hash) ? hashOpFromJSON(object.hash) : 0,
    };
  },
  ...
  toJSON(message: InnerSpec): unknown {
    ...
    if (message.childOrder?.length) {
      obj.child_order = message.childOrder.map((e) => Math.round(e));
    }
    if (message.childSize !== 0) {
      obj.child_size = Math.round(message.childSize);
    }
    if (message.minPrefixLength !== 0) {
      obj.min_prefix_length = Math.round(message.minPrefixLength);
    }
    if (message.maxPrefixLength !== 0) {
      obj.max_prefix_length = Math.round(message.maxPrefixLength);
    }
    if (message.emptyChild.length !== 0) {
...
export const BatchProof: MessageFns<BatchProof, "cosmos.ics23.v1.BatchProof"> = {
...
export const BatchEntry: MessageFns<BatchEntry, "cosmos.ics23.v1.BatchEntry"> = {
...
export const CompressedBatchProof: MessageFns<CompressedBatchProof, "cosmos.ics23.v1.CompressedBatchProof"> = {
  ...
  fromJSON(object: any): CompressedBatchProof {
    return {
      entries: globalThis.Array.isArray(object?.entries)
        ...
        : [],
      lookupInners: globalThis.Array.isArray(object?.lookup_inners)
  ...
  toJSON(message: CompressedBatchProof): unknown {
    ...
    if (message.lookupInners?.length) {
      obj.lookup_inners = message.lookupInners.map((e) => InnerOp.toJSON(e));
    }
    return obj;
  },
...
export const CompressedBatchEntry: MessageFns<CompressedBatchEntry, "cosmos.ics23.v1.CompressedBatchEntry"> = {
...
export const CompressedExistenceProof: MessageFns<
...
export const CompressedNonExistenceProof: MessageFns<
