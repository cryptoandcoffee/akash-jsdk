...
export const ModuleDescriptor: MessageFns<ModuleDescriptor, "cosmos.app.v1alpha1.ModuleDescriptor"> = {
...
export const PackageReference: MessageFns<PackageReference, "cosmos.app.v1alpha1.PackageReference"> = {
...
export const MigrateFromInfo: MessageFns<MigrateFromInfo, "cosmos.app.v1alpha1.MigrateFromInfo"> = {
