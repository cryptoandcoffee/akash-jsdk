...
import { Consensus } from "../../../../tendermint/version/types.ts";
...
export const Block: MessageFns<Block, "cosmos.base.tendermint.v1beta1.Block"> = {
...
export const Header: MessageFns<Header, "cosmos.base.tendermint.v1beta1.Header"> = {
