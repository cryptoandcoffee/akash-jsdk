...
export const MsgCreateCertificate: MessageFns<MsgCreateCertificate, "akash.cert.v1.MsgCreateCertificate"> = {
...
export const MsgRevokeCertificate: MessageFns<MsgRevokeCertificate, "akash.cert.v1.MsgRevokeCertificate"> = {
