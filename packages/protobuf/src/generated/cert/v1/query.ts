...
export const CertificateResponse: MessageFns<CertificateResponse, "akash.cert.v1.CertificateResponse"> = {
  $type: "akash.cert.v1.CertificateResponse" as const,
...
export const QueryCertificatesRequest: MessageFns<QueryCertificatesRequest, "akash.cert.v1.QueryCertificatesRequest"> =
  {
    $type: "akash.cert.v1.QueryCertificatesRequest" as const,
...
> = {
  $type: "akash.cert.v1.QueryCertificatesResponse" as const,
