...
export const GenesisCertificate: MessageFns<GenesisCertificate, "akash.cert.v1.GenesisCertificate"> = {
  $type: "akash.cert.v1.GenesisCertificate" as const,

  encode(message: GenesisCertificate, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.owner !== "") {
...
export const GenesisState: MessageFns<GenesisState, "akash.cert.v1.GenesisState"> = {
