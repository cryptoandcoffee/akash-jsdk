...
export const EventDeploymentCreated: MessageFns<EventDeploymentCreated, "akash.deployment.v1.EventDeploymentCreated"> =
  {
...
export const EventDeploymentUpdated: MessageFns<EventDeploymentUpdated, "akash.deployment.v1.EventDeploymentUpdated"> =
  {
...
export const EventDeploymentClosed: MessageFns<EventDeploymentClosed, "akash.deployment.v1.EventDeploymentClosed"> = {
...
export const EventGroupStarted: MessageFns<EventGroupStarted, "akash.deployment.v1.EventGroupStarted"> = {
...
export const EventGroupPaused: MessageFns<EventGroupPaused, "akash.deployment.v1.EventGroupPaused"> = {
...
export const EventGroupClosed: MessageFns<EventGroupClosed, "akash.deployment.v1.EventGroupClosed"> = {
