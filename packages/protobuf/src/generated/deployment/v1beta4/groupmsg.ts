...
export const MsgCloseGroup: MessageFns<MsgCloseGroup, "akash.deployment.v1beta4.MsgCloseGroup"> = {
  $type: "akash.deployment.v1beta4.MsgCloseGroup" as const,
...
> = {
  $type: "akash.deployment.v1beta4.MsgCloseGroupResponse" as const,
...
export const MsgPauseGroup: MessageFns<MsgPauseGroup, "akash.deployment.v1beta4.MsgPauseGroup"> = {
  $type: "akash.deployment.v1beta4.MsgPauseGroup" as const,
...
> = {
  $type: "akash.deployment.v1beta4.MsgPauseGroupResponse" as const,
...
export const MsgStartGroup: MessageFns<MsgStartGroup, "akash.deployment.v1beta4.MsgStartGroup"> = {
  $type: "akash.deployment.v1beta4.MsgStartGroup" as const,
...
> = {
  $type: "akash.deployment.v1beta4.MsgStartGroupResponse" as const,
