...
export const MsgUpdateParams: MessageFns<MsgUpdateParams, "akash.deployment.v1beta4.MsgUpdateParams"> = {
  $type: "akash.deployment.v1beta4.MsgUpdateParams" as const,
...
> = {
  $type: "akash.deployment.v1beta4.MsgUpdateParamsResponse" as const,
