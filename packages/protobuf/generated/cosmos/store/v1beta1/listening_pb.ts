...
import { CommitResponse, FinalizeBlockRequest, FinalizeBlockResponse } from "../../../cometbft/abci/v2/types_pb.js";
...
export class BlockMetadata extends Message<BlockMetadata> {
  /**
   * @generated from field: cometbft.abci.v2.CommitResponse response_commit = 6;
   */
  responseCommit?: CommitResponse;

  /**
   * @generated from field: cometbft.abci.v2.FinalizeBlockRequest request_finalize_block = 7;
   */
  requestFinalizeBlock?: FinalizeBlockRequest;

  /**
   * TODO: should we renumber this?
   *
   * @generated from field: cometbft.abci.v2.FinalizeBlockResponse response_finalize_block = 8;
   */
  responseFinalizeBlock?: FinalizeBlockResponse;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 6, name: "response_commit", kind: "message", T: CommitResponse },
    { no: 7, name: "request_finalize_block", kind: "message", T: FinalizeBlockRequest },
    { no: 8, name: "response_finalize_block", kind: "message", T: FinalizeBlockResponse },
  ]);
