...
import { ABCIParams, BlockParams, EvidenceParams, FeatureParams, SynchronyParams, ValidatorParams } from "../../../cometbft/types/v2/params_pb.js";
...
export class MsgUpdateParams extends Message<MsgUpdateParams> {
   ...
   *
   * @generated from field: cometbft.types.v2.BlockParams block = 2;
   */
  block?: BlockParams;

  /**
   * @generated from field: cometbft.types.v2.EvidenceParams evidence = 3;
   */
  evidence?: EvidenceParams;

  /**
   * @generated from field: cometbft.types.v2.ValidatorParams validator = 4;
   */
