...
import { Event } from "../../../../cometbft/abci/v2/types_pb.js";
import { Block } from "../../../../cometbft/types/v2/block_pb.js";
...
export class TxResponse extends Message<TxResponse> {
   ...
   *
   * @generated from field: repeated cometbft.abci.v2.Event events = 13;
   */
  events: Event[] = [];
...
export class Result extends Message<Result> {
   ...
   *
   * @generated from field: repeated cometbft.abci.v2.Event events = 3;
   */
  events: Event[] = [];
...
export class SearchBlocksResult extends Message<SearchBlocksResult> {
   ...
   *
   * @generated from field: repeated cometbft.types.v2.Block blocks = 6;
   */
  blocks: Block[] = [];
