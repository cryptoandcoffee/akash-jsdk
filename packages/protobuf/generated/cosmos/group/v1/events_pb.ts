 ...
 *
 * @generated from message cosmos.group.v1.EventTallyError
 */
export class EventTallyError extends Message<EventTallyError> {
  /**
   * proposal_id is the unique ID of the proposal.
   *
   * @generated from field: uint64 proposal_id = 1;
  ...
  constructor(data?: PartialMessage<EventTallyError>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cosmos.group.v1.EventTallyError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "proposal_id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 2, name: "error_message", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): EventTallyError {
    return new EventTallyError().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): EventTallyError {
    return new EventTallyError().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): EventTallyError {
    return new EventTallyError().fromJsonString(jsonString, options);
  }

  static equals(a: EventTallyError | PlainMessage<EventTallyError> | undefined, b: EventTallyError | PlainMessage<EventTallyError> | undefined): boolean {
    return proto3.util.equals(EventTallyError, a, b);
  }
}
