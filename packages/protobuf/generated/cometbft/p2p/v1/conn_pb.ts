...
// @generated from file cometbft/p2p/v1/conn.proto (package cometbft.p2p.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message cometbft.p2p.v1.PacketPing
 */
export class PacketPing extends Message<PacketPing> {
  ...
  static readonly typeName = "cometbft.p2p.v1.PacketPing";
 ...
 *
 * @generated from message cometbft.p2p.v1.PacketPong
 */
export class PacketPong extends Message<PacketPong> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cometbft.p2p.v1.PacketPong";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
 ...
 * is fully received.
 *
 * @generated from message cometbft.p2p.v1.PacketMsg
 */
export class PacketMsg extends Message<PacketMsg> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cometbft.p2p.v1.PacketMsg";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message cometbft.p2p.v1.Packet
 */
export class Packet extends Message<Packet> {
  /**
   * Sum of all possible messages.
   *
   * @generated from oneof cometbft.p2p.v1.Packet.sum
   */
  sum: {
    /**
     * @generated from field: cometbft.p2p.v1.PacketPing packet_ping = 1;
     */
    value: PacketPing;
    case: "packetPing";
  } | {
    /**
     * @generated from field: cometbft.p2p.v1.PacketPong packet_pong = 2;
     */
    value: PacketPong;
    case: "packetPong";
  } | {
    /**
     * @generated from field: cometbft.p2p.v1.PacketMsg packet_msg = 3;
     */
    value: PacketMsg;
    case: "packetMsg";
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cometbft.p2p.v1.Packet";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message cometbft.p2p.v1.AuthSigMessage
 */
export class AuthSigMessage extends Message<AuthSigMessage> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cometbft.p2p.v1.AuthSigMessage";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
