...
// @generated from file cometbft/p2p/v1/types.proto (package cometbft.p2p.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message cometbft.p2p.v1.NetAddress
 */
export class NetAddress extends Message<NetAddress> {
  ...
  static readonly typeName = "cometbft.p2p.v1.NetAddress";
 ...
 *
 * @generated from message cometbft.p2p.v1.ProtocolVersion
 */
export class ProtocolVersion extends Message<ProtocolVersion> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cometbft.p2p.v1.ProtocolVersion";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * p2p handshake.
 *
 * @generated from message cometbft.p2p.v1.DefaultNodeInfo
 */
export class DefaultNodeInfo extends Message<DefaultNodeInfo> {
  /**
   * @generated from field: cometbft.p2p.v1.ProtocolVersion protocol_version = 1;
   */
  ...
  /**
   * @generated from field: cometbft.p2p.v1.DefaultNodeInfoOther other = 8;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cometbft.p2p.v1.DefaultNodeInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message cometbft.p2p.v1.DefaultNodeInfoOther
 */
export class DefaultNodeInfoOther extends Message<DefaultNodeInfoOther> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cometbft.p2p.v1.DefaultNodeInfoOther";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
