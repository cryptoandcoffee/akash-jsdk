...
export class Proof extends Message<Proof> {
  ...
  static readonly typeName = "cometbft.crypto.v1.Proof";
...
export class ValueOp extends Message<ValueOp> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cometbft.crypto.v1.ValueOp";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class DominoOp extends Message<DominoOp> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cometbft.crypto.v1.DominoOp";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class ProofOp extends Message<ProofOp> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cometbft.crypto.v1.ProofOp";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class ProofOps extends Message<ProofOps> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cometbft.crypto.v1.ProofOps";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
