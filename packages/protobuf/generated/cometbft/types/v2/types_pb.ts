...
import { Proof } from "../../crypto/v1/proof_pb.js";
import { Consensus } from "../../version/v1/types_pb.js";
...
proto3.util.setEnumType(SignedMsgType, "cometbft.types.v2.SignedMsgType", [
...
export class PartSetHeader extends Message<PartSetHeader> {
  ...
  static readonly typeName = "cometbft.types.v2.PartSetHeader";
...
export class Part extends Message<Part> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cometbft.types.v2.Part";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class BlockID extends Message<BlockID> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cometbft.types.v2.BlockID";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class Header extends Message<Header> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cometbft.types.v2.Header";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class Data extends Message<Data> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cometbft.types.v2.Data";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class Vote extends Message<Vote> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cometbft.types.v2.Vote";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 11, name: "non_rp_extension", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
    { no: 12, name: "non_rp_extension_signature", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
  ]);
...
export class Commit extends Message<Commit> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cometbft.types.v2.Commit";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class CommitSig extends Message<CommitSig> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cometbft.types.v2.CommitSig";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class ExtendedCommit extends Message<ExtendedCommit> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cometbft.types.v2.ExtendedCommit";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "height", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
    { no: 2, name: "round", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 3, name: "block_id", kind: "message", T: BlockID },
...
export class ExtendedCommitSig extends Message<ExtendedCommitSig> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cometbft.types.v2.ExtendedCommitSig";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "block_id_flag", kind: "enum", T: proto3.getEnumType(BlockIDFlag) },
    { no: 2, name: "validator_address", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
    { no: 3, name: "timestamp", kind: "message", T: Timestamp },
    ...
    { no: 7, name: "non_rp_extension", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
    { no: 8, name: "non_rp_extension_signature", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
  ]);
...
export class Proposal extends Message<Proposal> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cometbft.types.v2.Proposal";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "type", kind: "enum", T: proto3.getEnumType(SignedMsgType) },
    { no: 2, name: "height", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
    { no: 3, name: "round", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
...
export class SignedHeader extends Message<SignedHeader> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cometbft.types.v2.SignedHeader";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class LightBlock extends Message<LightBlock> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cometbft.types.v2.LightBlock";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class BlockMeta extends Message<BlockMeta> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cometbft.types.v2.BlockMeta";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class TxProof extends Message<TxProof> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cometbft.types.v2.TxProof";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
