...
// @generated from file cometbft/types/v2/evidence.proto (package cometbft.types.v2, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message cometbft.types.v2.Evidence
 */
export class Evidence extends Message<Evidence> {
  /**
   * The type of evidence.
   *
   * @generated from oneof cometbft.types.v2.Evidence.sum
   */
  sum: {
    /**
     * @generated from field: cometbft.types.v2.DuplicateVoteEvidence duplicate_vote_evidence = 1;
     */
    value: DuplicateVoteEvidence;
    case: "duplicateVoteEvidence";
  } | {
    /**
     * @generated from field: cometbft.types.v2.LightClientAttackEvidence light_client_attack_evidence = 2;
     */
  ...
  static readonly typeName = "cometbft.types.v2.Evidence";
 ...
 *
 * @generated from message cometbft.types.v2.DuplicateVoteEvidence
 */
export class DuplicateVoteEvidence extends Message<DuplicateVoteEvidence> {
  /**
   * @generated from field: cometbft.types.v2.Vote vote_a = 1;
   */
  voteA?: Vote;

  /**
   * @generated from field: cometbft.types.v2.Vote vote_b = 2;
   */
  voteB?: Vote;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cometbft.types.v2.DuplicateVoteEvidence";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message cometbft.types.v2.LightClientAttackEvidence
 */
export class LightClientAttackEvidence extends Message<LightClientAttackEvidence> {
  /**
   * @generated from field: cometbft.types.v2.LightBlock conflicting_block = 1;
   */
  ...
  /**
   * @generated from field: repeated cometbft.types.v2.Validator byzantine_validators = 3;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cometbft.types.v2.LightClientAttackEvidence";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message cometbft.types.v2.EvidenceList
 */
export class EvidenceList extends Message<EvidenceList> {
  /**
   * @generated from field: repeated cometbft.types.v2.Evidence evidence = 1;
   */
  evidence: Evidence[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cometbft.types.v2.EvidenceList";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
